  ...
  async function load() {
    ...
    try {
      ...
      if (res.meta.status >= 200 && res.meta.status < 300) {
        const list = Array.isArray((res.data as any)?.permissions)
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <Button
          data-testid="rbac-permissions-refresh"
          variant="secondary"
          onClick={load}
      ...
      {error && (
        <div
          ...
          data-testid="rbac-permissions-error"
        >
          {error}
        </div>
      )}
      ...
      <div className="rounded-md border p-3 space-y-2">
        {perms.length === 0 ? (
          <div
            ...
            data-testid="rbac-permissions-empty"
          >
            No permissions loaded. Click Refresh.
          </div>
        ) : (
          <div className="space-y-2">
            {perms.map((p) => (
              <div
                ...
                data-testid={`rbac-permissions-item-${p.id || p.key}`}
              >
