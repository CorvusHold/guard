    ...
    <div className="space-y-3" data-testid="fga-groups">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button
            data-testid="fga-groups-refresh"
            variant="secondary"
            onClick={() => load()}
      ...
      {message && (
        <div
          ...
          data-testid="fga-groups-message"
        >
          {message}
        </div>
      )}
            ...
            <tbody>
              {groups.map((g) => (
                <tr
                  ...
                  data-testid={`fga-group-item-${g.id}`}
                >
